...
exports.onNewBooking = functions
    ...
    .onCreate(async (snapshot, context) => {
        ...
        const mailToFlorine = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background: #3a7d1e; color: white; padding: 20px; border-radius: 10px 10px 0 0;">
                    ...
                    <div style="background: white; padding: 25px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 10px 10px;">
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016; width: 120px;">Date</td>
                                <td style="padding: 8px 0;">${booking.day}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Horaire</td>
                                <td style="padding: 8px 0;">${booking.time}</td>
                            </tr>
                            <tr style="border-top: 1px solid #eee;">
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Nom</td>
                                <td style="padding: 8px 0;">${booking.prenom} ${booking.nom}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Société</td>
                                <td style="padding: 8px 0;">${booking.societe}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Email</td>
                                <td style="padding: 8px 0;"><a href="mailto:${booking.email}">${booking.email}</a></td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Téléphone</td>
                                <td style="padding: 8px 0;">${booking.telephone || "Non renseigné"}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; font-weight: bold; color: #2d5016;">Demande</td>
        ...
        const mailToVisitor = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background: #3a7d1e; color: white; padding: 20px; border-radius: 10px 10px 0 0; text-align: center;">
                    ...
                    <div style="background: white; padding: 25px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 10px 10px;">
                        ...
                        <div style="background: #e8f5e0; padding: 15px; border-radius: 8px; margin: 15px 0;">
                        ...
                        <p style="color: #5c5c5c; font-size: 0.9em; margin-top: 20px;">
                            ...
                            <a href="http://www.fruytier.com" style="color: #3a7d1e;">www.fruytier.com</a>
                        </p>
                    </div>
                </div>
            `,
